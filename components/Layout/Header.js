      ...
      >
        <nav className="max-w-screen-xl px-6 sm:px-8 lg:px-16 mx-auto grid grid-flow-col py-3 sm:py-4">
          <div className="col-start-1 col-end-2 flex items-center">
            ...
            <span className="text-xl px-4 py-2 mx-2 font-medium animation-hover inline-block relative text-black-500 hover:text-green-200">The BEST NP Technologies</span>
          </div>
